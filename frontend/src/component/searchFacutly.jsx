                                    ...
                                    <section className="section section-shaped">
                                        ...
                                        {this.state.isSearch ? (<>
                                            ...
                                            <button
                                                    ...
                                                    onClick={() => {
                                                        this.setState((prevState) => ({
                                                            ...
                                                            testCreated: [...prevState.testCreated, this.state.top3Result[1].org2TestCreated]
                                                        }), () => {
                                                            this.setTutor()
                                                        })
                                                    }}>
                                            ...
                                            <button
                                                ...
                                                onClick={() => {
                                                    this.setState((prevState) => ({
                                                        myTutor: this.state.top3Result[2]._id,
                                                        testCreated: [...prevState.testCreated, this.state.top3Result[2].org3TestCreated]
                                                    }), () => {
                                                        this.setTutor()
                                                    })
                                                }}>
